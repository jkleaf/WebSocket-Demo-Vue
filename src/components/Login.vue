...
<el-tabs type="border-card">
  <el-tab-pane label="登录">
    <div class="block">
      <el-form ref="loginForm" :rules="rules" :model="loginForm" label-width="0px" auto-complete="off" v-loading="loading">
        ...
        <el-form-item prop="captcha" style="text-align: left">
          ...
          <img id="verImg" :src="verifyImg" @click="switchCaptcha" width="130px" height="48px" style="" :alt="loaded?'验证码加载中':'验证码加载失败'" />
        </el-form-item>
  ...
  <el-tab-pane label="注册">
    <div class="block">
      <el-form ref="regValidateForm" :model="regValidateForm" status-icon :rules="regRules" label-width="100px" auto-complete="off" class="demo-ruleForm">
